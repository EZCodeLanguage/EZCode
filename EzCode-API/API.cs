...
namespace EzCode_API
{
    ...
    public static class API
    {
        ...
        static bool ifcheck(multimids Mid, string v1, string v2)
        {
        ...
        static string getEquation(string value, int a, List<string> parts)
        {
            string brackets = "";
            int ended = 0;
            List<string> texts = new List<string>();
        ...
        static int[] getEquationWithNext(string value, int a, List<string> parts)
        {
            string brackets = "";
            int ended = 0;
            int next = 0;
