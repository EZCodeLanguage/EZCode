...
namespace EZCode
{
    public class EZProj
    {
        ...
        /// </summary>
        public static readonly string DefaultIconPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "EZCode", "EZCode", "EZCode_Logo.ico");
        /// <summary>
        /// Icon for project
        /// </summary>
